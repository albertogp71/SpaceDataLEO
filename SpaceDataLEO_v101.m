...
% Starlink, e~0).
%
% Author: generated for Alberto (Politecnico di Torino)
...
yline(mean(capacityPerm),  'g--','LineWidth',1.0,'HandleVisibility','off');
yline(mean(capacityInterm),'r--','LineWidth',1.0,'HandleVisibility','off');
yline(mean(capacityTotal), 'k--','LineWidth',1.0,'HandleVisibility','off');
...
yline(mean(numTotalProposals),'b--','LineWidth',1.0,'HandleVisibility','off');
yline(mean(numMutualPairs),   'm--','LineWidth',1.0,'HandleVisibility','off');
yline(mean(numIntermLinks),   'g--','LineWidth',1.0,'HandleVisibility','off');
...
yline(mean(numHemiRejected),    'b--',          'LineWidth',1.0,'HandleVisibility','off');
yline(mean(numEarthBlocked),    'Color',[0.3 0.3 0.3],'LineStyle','--','LineWidth',1.0,'HandleVisibility','off');
yline(mean(numSunBlockedInterm),'Color',[0.6 0.2 0.8],'LineStyle','--','LineWidth',1.0,'HandleVisibility','off');
yline(mean(numBusyTerminal),    'Color',[0.1 0.6 0.6],'LineStyle','--','LineWidth',1.0,'HandleVisibility','off');
xlabel('Time [min]'); ylabel('Count');
...
yline(mean(numSunBlockedPerm),  'Color',[1 0.6 0],        'LineStyle','--','LineWidth',1.0,'HandleVisibility','off');
yline(mean(numSunBlockedInterm),'Color',[0.6 0.2 0.8],    'LineStyle','--','LineWidth',1.0,'HandleVisibility','off');
yline(mean(numEclipsed),        'Color',[0.4 0.4 0.4],    'LineStyle','--','LineWidth',1.0,'HandleVisibility','off');
xlabel('Time [min]'); ylabel('Count');
...
figure('Color','w');
subplot(2,1,1);
plot(tVec/60, bisectionBW, 'b-','LineWidth',1.5); hold on;
yline(mean(bisectionBW),'b--','LineWidth',1.0,'HandleVisibility','off');
xlabel('Time [min]'); ylabel('Bisection bandwidth [Gbps]');
title('Worst-case (minimum-cut) Bisection Bandwidth vs Time'); grid on;
subplot(2,1,2);
plot(tVec/60, oversubRatio, 'Color',[0.85 0.33 0.1],'LineWidth',1.5); hold on;
yline(mean(oversubRatio(~isnan(oversubRatio))),'Color',[0.85 0.33 0.1],'LineStyle','--','LineWidth',1.0,'HandleVisibility','off');
...
figure('Color','w');
subplot(3,1,1);
plot(tVec/60, meanHopLatency, 'b-','LineWidth',1.5); hold on;
yline(mean(meanHopLatency,'omitnan'),'b--','LineWidth',1.0,'HandleVisibility','off');
xlabel('Time [min]'); ylabel('Delay [ms]');
title('Mean Single-Hop ISL Propagation Delay'); grid on;
subplot(3,1,2);
plot(tVec/60, meanE2ELatency, 'm-','LineWidth',1.5); hold on;
yline(mean(meanE2ELatency,'omitnan'),'m--','LineWidth',1.0,'HandleVisibility','off');
xlabel('Time [min]'); ylabel('Delay [ms]');
title('Mean End-to-End Shortest-Path Propagation Delay (reachable pairs)'); grid on;
subplot(3,1,3);
plot(tVec/60, maxE2ELatency, 'r-','LineWidth',1.5); hold on;
yline(mean(maxE2ELatency,'omitnan'),'r--','LineWidth',1.0,'HandleVisibility','off');
xlabel('Time [min]'); ylabel('Delay [ms]');
...
figure('Color','w');
subplot(3,1,1);
plot(tVec/60, double(netConnected), 'k-','LineWidth',1.5); hold on;
yline(mean(double(netConnected)),'k--','LineWidth',1.0,'HandleVisibility','off');
ylim([-0.05 1.05]); yticks([0 1]); yticklabels({'Partitioned','Connected'});
xlabel('Time [min]'); title('Network Connectivity vs Time'); grid on;
subplot(3,1,2);
plot(tVec/60, fracReachable*100, 'b-','LineWidth',1.5); hold on;
yline(mean(fracReachable)*100,'b--','LineWidth',1.0,'HandleVisibility','off');
xlabel('Time [min]'); ylabel('Reachable pairs [%]');
title('Fraction of Reachable Satellite Pairs vs Time'); grid on;
subplot(3,1,3);
plot(tVec/60, fracLinksActive*100, 'Color',[0 0.6 0.3],'LineWidth',1.5); hold on;
yline(mean(fracLinksActive)*100,'Color',[0 0.6 0.3],'LineStyle','--','LineWidth',1.0,'HandleVisibility','off');
...
yline(mean(meanHops,'omitnan'),'b--','LineWidth',1.0,'HandleVisibility','off');
yline(mean(maxHops, 'omitnan'),'r--','LineWidth',1.0,'HandleVisibility','off');
